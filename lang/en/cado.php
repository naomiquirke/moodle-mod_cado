...
$string['usehtml'] = 'Use HTML version in preference to JSON.';
$string['usehtml_desc'] = 'If enabled, any HTML version of the CADO report is used for immediate display in preference to using the JSON (except in mobile app). This may be useful if your output template is changing and you wish to preserve the look of the previous applied template.';
