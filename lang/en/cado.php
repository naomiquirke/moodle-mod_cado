...
$string['storegenerated'] = 'Store HTML version.';
$string['storegenerated_desc'] = 'If enabled, an HTML version of the CADO report is stored in the database, and used for immediate display (except for in mobile app). CADO may also then be viewed in external reports.';
