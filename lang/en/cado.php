...
$string['storegenerated_desc'] = 'If enabled, an HTML version of the CADO report is stored in the database. Generated CADO may then be viewed in external reports. Enables use of the usehtml setting below.';
$string['usehtml'] = 'Use HTML version in preference to JSON for approved CADOs.';
$string['usehtml_desc'] = 'If enabled, any HTML version of an approved CADO report is used for immediate display in preference to using the JSON (except in mobile app). This may be useful if your site settings have changed and you wish to preserve exactly as approved.';
