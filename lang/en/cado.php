...
$string['CADO'] = 'Course Assessment and Delivery Outline';
...
$string['cado:compare'] = 'Carry out a omparison between previously generated CADOs';
...
$string['modulenameplural'] = 'Course Assessment and Delivery Outlines';
...
$string['outputinstruction'] = 'Choose output for CADO report';
$string['pluginadministration'] = 'Plugin administration';
$string['pluginname'] = 'CADO Report';
$string['printview'] = 'Print layout view';
$string['privacy:metadata:approverpurpose'] = 'ID of approve-user, who approved or did not approve the CADO report most recently.';
...
$string['privacy:metadata:generatorpurpose'] = 'ID of generate-user, who generated the CADO report most recently from module settings, or who last sent the CADO for approval.';
...
$string['privacy:metadata:timepurpose'] = 'Time that approve-comments were made or reposted by approve-user.';
$string['quiz'] = 'Quizzes';
...
$string['settings'] = 'CADO report settings';
$string['showlogo'] = 'Include logo';
$string['showlogo_desc'] = 'Include logo (from admin settings) on CADO report';
